...
import { LuLink, LuZap, LuShield, LuActivity, LuArrowRight, LuCheck } from "react-icons/lu"
...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative px-6 lg:px-8 py-24 lg:py-32 overflow-hidden bg-background">
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl leading-8 text-muted-foreground max-w-2xl mx-auto">
              A powerful URL shortener built for modern marketing teams. Track clicks, analyze audiences, and manage your brand with custom domains.
            </p>
            <div className="mt-8">
                <PublicShortener />
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Stop using basic link shorteners. Upgrade to a platform that gives you control, visibility, and security.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Track clicks by location, device, and browser. Export data for deeper analysis.',
                  icon: LuActivity,
                },
                {
                  name: 'Custom Domains',
                  description: 'Connect your own domain name to build trust and brand recognition.',
                  icon: LuLink,
                },
                {
                  name: 'Enterprise Security',
                  description: 'SSO, detailed audit logs, and role-based access control for your team.',
                  icon: LuShield,
                },
                {
                    name: 'Lightning Fast',
                    description: 'Optimized redirect performance ensuring your users never wait.',
                    icon: LuZap,
                },
                {
                    name: 'QR Codes',
                    description: 'Generate QR codes automatically for every link you create.',
                    icon: LuCheck, // Using generic icon for QR
                },
                 {
                    name: 'Team Collaboration',
                    description: 'Invite your team and manage links together in shared workspaces.',
      ...
      <section className="relative isolate px-6 py-24 sm:py-32 lg:px-8 bg-zinc-900 text-white dark:bg-primary/5">
          <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-primary dark:text-white">Ready to get started?</h2>
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-zinc-300 dark:text-muted-foreground">
                  Join thousands of marketers and developers who use our platform to manage their links.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                  <Button size="lg" variant="secondary" asChild>
                      <Link href="/register">Create Free Account</Link>
                  </Button>
                  <Button size="lg" variant="link" className="text-white dark:text-primary" asChild>
                      <Link href="/contact">Contact Sales <LuArrowRight className="ml-2 w-4 h-4" /></Link>
                  </Button>
              </div>
          </div>
      </section>
